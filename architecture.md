...
7. Возможность управления с клавиатуры
...
3. Поддержка уровня целочисленных характеристик пользователя (например, здоровья) до 10^9 по абсолютной величине
...
4. Только стандартная библиотека Python и tcod
...
* Корректный UI на 720p, 1080p, 2K, 4K
